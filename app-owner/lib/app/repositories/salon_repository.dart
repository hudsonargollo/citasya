...
class SalonRepository {
  ...
  Future<List<EService>> getEServices({String? salonId, int page = 1}) {
  ...
  Future<List<EService>> getPopularEServices({String? salonId, int page = 1}) {
    return _laravelApiClient.getSalonPopularEServices(salonId, page);
  }

  Future<List<EService>> getAvailableEServices({String? salonId, int page = 1}) {
    return _laravelApiClient.getSalonAvailableEServices(salonId, page);
  }

  Future<List<EService>> getFeaturedEServices({String? salonId, int page = 1}) {
    return _laravelApiClient.getSalonFeaturedEServices(salonId, page);
  }

  Future<List<Salon>> getSalons({int page = 1}) {
  ...
  Future<List<Salon>> getAcceptedSalons({int page = 1}) {
    return _laravelApiClient.getAcceptedSalons(page);
  }

  Future<List<Salon>> getFeaturedSalons({int page = 1}) {
    return _laravelApiClient.getFeaturedSalons(page);
  }

  Future<List<Salon>> getPendingSalons({int page = 1}) {
