...
class RegisterView extends GetView<AuthController> {
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const Text(
                                            "Únete a la red de servicios y especialistas más grande de Bolivia",
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                              fontSize: 12,
                                          ...
                                          // Full Name Field
                                          _buildFieldLabel("NOMBRE DEL PROPIETARIO"),
                                          ...
                                          // Phone Number Field
                                          _buildFieldLabel("NÚMERO DE TELÉFONO / WHATSAPP"),
                                          const SizedBox(height: 6),
                                          _buildPhoneInput(),
                                          const SizedBox(height: 14),
  ...
  Widget _buildNameInput() {
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (input) => controller.currentUser.value.name = input?.trim(),
        validator: (input) {
  ...
  Widget _buildPhoneInput() {
    return Container(
      ...
      child: IntlPhoneField(
        ...
        initialCountryCode: controller.currentUser.value.getPhoneNumber().countryISOCode.isNotEmpty
            ? controller.currentUser.value.getPhoneNumber().countryISOCode
            : 'BO',
        ...
        pickerDialogStyle: PickerDialogStyle(
          ...
          countryNameStyle: const TextStyle(fontSize: 13, color: Color(0xFF0F172A)),
  ...
  Widget _buildSubmitButton() {
    return Material(
      color: Colors.transparent,
      child: InkWell(
        onTap: controller.loading.isTrue ? null : () => controller.register(),
        borderRadius: BorderRadius.circular(99),
        child: Ink(
          height: 48,
          decoration: BoxDecoration(
