...
class FaqCategoryController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('faq_categories.create')->with("customFields", $html ?? false);
    }
    ...
    public function edit(int $id): RedirectResponse|View
    {
        ...
        return view('faq_categories.edit')->with('faqCategory', $faqCategory)->with("customFields", $html ?? false);
    }
