    ...
    <div class="card-body login-card-body">
        ...
        <form action="{{ url('/login') }}" method="post">
            ...
            @if (config('installer.demo_app'))
                <div class="my-4">
                    <div class="col-12 card card-outline card-{{setting("theme_color","primary")}}">
                        <div class="card-body">
                            <div class="text-bold">Admin</div>
                            <small>User: admin@demo.com | Password: 123456</small>
                            <div class="text-bold mt-3">Salon Owner</div>
                            <small>User: salon@demo.com | Password: 123456</small>
