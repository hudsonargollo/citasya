...
<div class="mt-14 relative max-w-5xl mx-auto" data-purpose="hero-device-composition"><div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 px-4 animate-float"><div class="bg-white/95 backdrop-blur-md px-5 py-2.5 rounded-3xl shadow-xl border border-lime-200/80 flex items-center gap-3.5 hover:scale-105 transition-transform duration-300"><img alt="CitasYa 3D Icon" class="w-12 h-12 object-contain drop-shadow-md" src="/images/brand/icon_3d.png?v=2"/><div class="text-left"><span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase bg-emerald-100 text-emerald-800 tracking-wider">Identidad Oficial</span><p class="font-display font-black text-sm text-slate-900 tracking-tight leading-snug">Auto-Agendamiento Inteligente SCZ</p></div><div class="h-8 w-px bg-slate-200 hidden sm:block"></div><img alt="CitasYa 3D Lockup" class="h-9 w-auto object-contain hidden sm:block" src="/images/brand/logo_2d_horizontal.png?v=2"/></div></div>
