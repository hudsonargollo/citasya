        ...
        extend: {
          colors: {
            brand: {
              ...
              500: '#22C55E',
              600: '#16A34A',
              DEFAULT: '#84CC16', // High-energy Lime/Chartreuse from Janjiyuk
              lime: '#A3E635',
              darklime: '#65A30D',
              neon: '#84CC16',
              mint: '#ECFDF5',
          ...
          boxShadow: {
            'janjiyuk': '0 24px 60px -15px rgba(132, 204, 22, 0.22)',
...
<style data-purpose="custom-animations-and-shapes">
    ...
    /* Janjiyuk-style pill badge with rotating star / sparkle accent */
    .starburst-badge {
...
<!-- Subtle promotional bar inspired by Dribbble & Janjiyuk header badge -->
...
<main>
<!-- BEGIN: HeroSection -->
<!-- Janjiyuk Inspired Composition: Fresh Lime rounded backdrop, central tablet showcase, floating widgets -->
...
<div class="mt-14 relative max-w-5xl mx-auto" data-purpose="hero-device-composition"><div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 px-4 animate-float"><div class="bg-white/95 backdrop-blur-md px-5 py-2.5 rounded-3xl shadow-xl border border-lime-200/80 flex items-center gap-3.5 hover:scale-105 transition-transform duration-300"><img alt="CitasYa 3D Icon" class="w-12 h-12 object-contain drop-shadow-md" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBTVfVHY55wvRcMJ-WTQHJUdaFT-4mpWJkAdkUZ299KxOv07HN2JHV9rrZpYB5xFCoHmqu76fzdCuosGLOPxObAm4wxGuF3OPZ-2TNmXkNP3Fa0pSgGloBbXPBBEputQPCvmiuA1PpZWjShIARy_L6w3OgTxJsnql5TglhE5j7ussgbc-_RoYU-uYyyFMa0yKEikuX1WnVqguy5-nN9Tr9VpHnTYNiCUeP_YjbYRXN0oGtu-w-VNVKgOMP2JVU7yPeYbA"/><div class="text-left"><span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase bg-emerald-100 text-emerald-800 tracking-wider">Identidad Oficial</span><p class="font-display font-black text-sm text-slate-900 tracking-tight leading-snug">Auto-Agendamiento Inteligente SCZ</p></div><div class="h-8 w-px bg-slate-200 hidden sm:block"></div><img alt="CitasYa 3D Lockup" class="h-9 w-auto object-contain hidden sm:block" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDCM1MXY1QpjvgaivgSy8RLpHsCS8ao4j0Y5OHyOeNmGbS1bSBLwlFvFpt35nDeeWARnNnufon0uKT9956Cw8dfFjL3Bg-ZY3_GGySTQvNwUiaCThNthPRo9aBW0XlpQELJpfSGkP5v-7ZjzfY9ERfeqbOAXiR4gb4eSiKC1uqjh_8BlIHW3sJ3CBevnl5LRPfTWc3CF0YU1J07Fi3huKmsMYFZNtYGirnDz-WTH-PXiQbETGHgXLEvWDZGF3UrTsdGiw"/></div></div>
...
<!-- Floating WhatsApp Auto-Confirmation Card (Janjiyuk Signature Floating Widget) -->
...
<!-- END: HeroSection -->
<!-- BEGIN: HowItWorks -->
<!-- Janjiyuk 01 - 02 - 03 Circular Badge Step Sequence -->
...
<!-- Janjiyuk Inspired Bento Box: WhatsApp focus, calendar widget, analytics for Santa Cruz businesses -->
...
<!-- Simulated Bar Chart from Janjiyuk Weekly Bookings Component -->
...
<!-- Janjiyuk High-Energy Lime CTA Banner Card -->
...
<!-- BEGIN: MainFooter -->
<!-- Dark Slate Neo-Modern Footer matching Janjiyuk Dribbble aesthetic -->
